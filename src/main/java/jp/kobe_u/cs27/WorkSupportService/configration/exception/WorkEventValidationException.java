...
/**
 * 作業イベントに関するバリデーション違反が発生した場合に発生する例外
 *
 * @author ing
 */
@Getter
public class WorkEventValidationException extends RuntimeException {
    /** シリアライズであることを保証？ */
     ...
     */
    public WorkEventValidationException(ErrorCode code, String error, String cause) {
