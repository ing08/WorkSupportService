...
/**
 * ログインログに関するバリデーション違反が発生した場合に発生する例外
 *
 * @author ing
 */
@Getter
public class LoginLogValidationException extends RuntimeException {
    /** シリアライズであることを保証？ */
     ...
     */
    public LoginLogValidationException(ErrorCode code, String error, String cause) {
