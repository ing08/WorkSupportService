...
/**
 * 作業状況に関するバリデーション違反が発生した場合に発生する例外
 *
 * @author ing
 */
@Getter
public class WorkStateValidationException extends RuntimeException {
    /** シリアライズであることを保証？ */
     ...
     */
    public WorkStateValidationException(ErrorCode code, String error, String cause) {
